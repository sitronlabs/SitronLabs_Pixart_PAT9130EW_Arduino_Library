 ...
 *
 * This example demonstrates basic usage of the PAT9130EW optical motion
 * tracking sensor. It initializes the sensor, then prints deltaX and deltaY
 * counts whenever motion is detected.
 *
 ...
 * - SDIO to MOSI through a 3.3k resistor and to MISO directly (required for 3-wire SPI)
 *
 * Author: Sitron Labs
 * Date: 2026
 */
